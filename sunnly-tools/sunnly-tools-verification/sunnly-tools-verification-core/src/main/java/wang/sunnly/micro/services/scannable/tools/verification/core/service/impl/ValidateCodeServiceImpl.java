package wang.sunnly.micro.services.scannable.tools.verification.core.service.impl;
...
import wang.sunnly.micro.services.scannable.tools.verification.core.properties.ValidateCodeProperties;
import wang.sunnly.micro.services.scannable.tools.verification.core.service.*;
    ...
    public void genValidateCode(ServletWebRequest request, String type, String id) {
        ...
        switch (StringUtils.upperCase(type)) {
            case "IMAGE":
                ...
                //存储验证码
                validateCodeStorage.save(request, key, id, code, expire);
