 ...
 *
 * @author Sunnly
 * @since 2019/7/24 14:46
 */

@Controller
public class BigFileUploadController {

    private String filePath = "E:\\workspace\\test\\up\\";

    private final String MODEL = "big";
    ...
    @ResponseBody
    public ObjectRestResponse mergeFile(String guid, String fileName) {
