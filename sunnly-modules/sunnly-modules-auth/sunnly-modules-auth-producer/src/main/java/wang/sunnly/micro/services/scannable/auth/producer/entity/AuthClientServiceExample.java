package wang.sunnly.micro.services.scannable.auth.producer.entity;
...
public class AuthClientServiceExample extends MyExample {
    ...
    public AuthClientServiceExample() {
